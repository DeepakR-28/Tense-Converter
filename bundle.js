...
var text = nlp(document.getElementById("inputText").value).sentences().toPastTense().text()
document.getElementById("outputText").innerHTML = text
}

window.pastTense = function(){
document.getElementById("outputText").innerHTML = "";
var text = nlp(document.getElementById("inputText").value).sentences().toPastTense().text()
document.getElementById("outputText").innerHTML = text
}

window.presentTense = function(){
document.getElementById("outputText").innerHTML = "";
var text = nlp(document.getElementById("inputText").value).sentences().toPresentTense().text()
document.getElementById("outputText").innerHTML = text
}
...
,{"compromise":2,"compromise-sentences":1}]},{},[3]);
